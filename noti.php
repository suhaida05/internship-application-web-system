...
include ("Email.php");
		 ...
		 if($p!=0) 
		 {
		  ...
		  $to="shda0512@gmail.com";
		  $subject='Permohonan Latihan Praktikal';
		...
		$message .= '<TR>';
		$message .= '<TD>'.$res['name'].' telah membuat permohonan untuk latihan praktikal.</TD>';
		$message .= '</TR>';
		...
		$message .= '-------------------------------------------------------' . "\n";
		  ...
		  if ($mail->send())
		  {
			echo '<script>alert("Permohonan telah berjaya dihantar!")</script>';
